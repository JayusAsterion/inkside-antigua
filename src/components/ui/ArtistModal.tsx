      ...
      {isOpen && artist ? (
        ...
        >
          <motion.div
            ...
            className="relative my-auto grid max-h-[92svh] w-full max-w-6xl overflow-y-auto border surface-line bg-ink-1000 shadow-[0_32px_120px_rgb(0_0_0/0.58)] lg:grid-cols-[minmax(0,0.95fr)_minmax(22rem,1.05fr)]"
          ...
          >
            ...
            <div className="relative min-h-[18rem] overflow-hidden border-b surface-line bg-ink-950 lg:min-h-[36rem] lg:border-b-0 lg:border-r">
              {image ? (
                <img
              ...
              <div className="absolute bottom-6 left-6 right-6 border border-bone-50/12 bg-ink-1000/42 p-4 backdrop-blur-sm">
                <p className="text-[0.68rem] font-extrabold uppercase tracking-[0.22em] text-bone-100/82">
                  {artist.specialty}
                </p>
                <p className="mt-2 font-display text-4xl uppercase leading-none text-bone-50">
                  {artist.name}
                </p>
              </div>
            </div>
