            ...
            >
              {image ? (
                <img
                  ...
                  className="absolute inset-0 h-full w-full object-cover opacity-94 brightness-95 contrast-110 saturate-90 transition duration-500 group-hover:scale-105 group-hover:opacity-100 group-hover:brightness-105 group-hover:saturate-100 md:opacity-88 md:brightness-85 md:saturate-75"
                  src={image}
                />
              ) : (
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-ink-1000/66 via-ink-950/16 to-ink-1000/6 md:from-ink-1000/76 md:via-ink-950/22" />
